...
class AdvanedCollectionViewCell: BaseCollectionViewCell {
    ...
    override func initialize() {
        ...
        layoutRefundLabel()
        configGureeteTitleLabel()
    }

    // MARK: - Helper Method
    
    func configGureeteTitleLabel() {
        ...
        let attrs2 = [NSAttributedString.Key.font : UIFont.systemFont(ofSize: FontSize.h2.rawValue, weight: .bold),
                      NSAttributedString.Key.foregroundColor: UIColor.second]
