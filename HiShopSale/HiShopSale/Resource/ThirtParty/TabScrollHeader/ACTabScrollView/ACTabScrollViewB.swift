...
@IBDesignable
open class ACTabScrollViewB: UIView, UIScrollViewDelegate {
    ...
    open var delegate: ACTabScrollViewDelegateB?
    open var dataSource: ACTabScrollViewDataSourceB?
    
    // MARK: Private Variables
    fileprivate var tabSectionScrollView: UIScrollView!
    fileprivate var contentSectionScrollView: UIScrollView!
    fileprivate var arrowView: ArrowViewB!
    
    fileprivate var cachedPageTabs: [Int: UIView] = [:]
    fileprivate var cachedPageContents: CacheQueueB<Int, UIView> = CacheQueueB()
    ...
    fileprivate func initialize() {
        ...
        arrowView = ArrowViewB(frame: CGRect(x: 0, y: 0, width: 30, height: 10))
...
public struct CacheQueueB<Key: Hashable, Value> {
