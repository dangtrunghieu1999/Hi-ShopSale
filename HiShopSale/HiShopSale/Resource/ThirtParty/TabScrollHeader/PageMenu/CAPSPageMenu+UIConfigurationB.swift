//
//  CAPSPageMenu+UIConfigurationB.swift
//  Hi-Shop
//
...
extension CAPSPageMenuB {
    func configurePageMenu(options: [CAPSPageMenuOptionB]) {
    ...
    func configureUserInterface() {
        ...
        let menuItemTapGestureRecognizer = UITapGestureRecognizer(
            target: self,
            action: #selector(CAPSPageMenuB.handleMenuItemTap(_:))
        )
        ...
        for controller in controllerArray {
            ...
            let menuItemView : MenuItemViewB = MenuItemViewB(frame: menuItemFrame)
